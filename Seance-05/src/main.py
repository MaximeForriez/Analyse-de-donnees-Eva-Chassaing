...
print(donnees.head(5)) # On affiche seulement les 5 premières données
print() # les print comme ça servent seulement à avoir une console lisible
# j'ai également mis des \n au début des print pour améliorer la lisiblité

#Calcul des moyennes des colonnes et arrondis en entier
# Au lieu de traiter nos données colones par colones, un peu comme numpy le module panda nous permet d'écrire du code 
# "comme si on l'écrivait pour une colonne" et de l'appliquer simultanément à chaque colonne
...
freq_echantillon = (moyennes / somme_moyennes).round(2) # deux décimales
...
# On récupère la première ligne qu'on met dans une liste
echantillon_1 = list(donnees.iloc[0])
print("\nÉchantillon 1 :", echantillon_1)

# -------------------------------------------------------------------
# Calcul des effectifs et des fréquences
# -------------------------------------------------------------------

n1 = sum(echantillon_1) # effectif total (n1 = 1000 comme on s'y attendait)
...
print("\nBornes inférieures à 95% :", bornes_inf)
